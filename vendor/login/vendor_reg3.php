...
// Check input errors before inserting in database
 if(empty($name_err)  && empty($username_err) && empty($email_err) && empty($password_err)){
     ...
     $sql = "INSERT INTO vendor (v_name, v_username, v_password,v_email, v_phoneno, v_address, v_gender  ,v_ser_places ,v_profession ,v_experience)  VALUES ('$name','$username','$password','$email','$m_no','$address','$gender','$services','$profession','$experience')";
