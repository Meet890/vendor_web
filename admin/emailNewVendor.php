...
$sql="SELECT * FROM registration  WHERE reg_username='$username' "; 
...
if($result){
   ...
   try {
    ...
    $mail->Body    = "Your account is registerd ..please wait for varify your payment,It's took 1-3 Day to confirmation. ".'</b>'.'We are contact soon via Email.';
    $mail->AltBody = '';
    $mail->send();
