...
$sql = "SELECT v_id, v_name ,v_iglink,v_fblink, v_username, v_profession, v_address, v_phoneno, v_discription, v_comp FROM vendor where v_username = '$v_username'";
...
?>
        ...
        <ul>
            <li>
                ...
                <h5 class="city mb-0"><?php echo $city ?></h5>
            </li>
            <li>
                <img src="assets/img/calling.png" alt="Phone Icon" class="png">
                <h5 class="call mb-0"><?php echo $phone ?></h5>
            </li>
        ...
        <ul>
            <li>
                ...
                <h5 class="city mb-0"><?php echo $fb ?></h5>
            </li>
            
            <li>
                <img src="assets/img/insta.jpg" alt="Location Icon" class="png">
                <h5 class="call mb-0"><?php echo $ig ?></h5>
            </li>   
        </ul>
    </div>
        </div>
